...
const TermsAndConditions = () => {
  return (
    <>
      <Header />
      <div className="container pt-10 mb-5 bg-white">
        <h2>Terms and Conditions</h2>
        <p>Welcome to babindia.com!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Bits And Bytes IT Solutions's Website, located at
          http://www.babindia.com/.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use babindia.com if you do not agree to
        ...
        <h3>Cookies</h3>
        <p>
          We employ the use of cookies. By accessing babindia.com, you agreed to
          use cookies in agreement with the Bits And Bytes IT Solutions's
          Privacy Policy.{" "}
        </p>
        <p>
        ...
        <h3>License</h3>
        <p>
          Unless otherwise stated, Bits And Bytes IT Solutions and/or its
          licensors own the intellectual property rights for all material on
          babindia.com. All intellectual property rights are reserved. You may
          access this from babindia.com for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from babindia.com</li>
          <li>Sell, rent or sub-license material from babindia.com</li>
          <li>Reproduce, duplicate or copy material from babindia.com</li>
          <li>Redistribute content from babindia.com</li>
        </ul>
        <p>
        ...
        <p>
          ...
          Bits And Bytes IT Solutions does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Bits And Bytes IT Solutions,its
          ...
          by applicable laws, Bits And Bytes IT Solutions shall not be liable
        ...
        <p>
          Bits And Bytes IT Solutions reserves the right to monitor all Comments
        ...
        <p>
          You hereby grant Bits And Bytes IT Solutions a non-exclusive license
        ...
        <p>
          ...
          the hyperlink compensates the absence of Bits And Bytes IT Solutions;
        ...
        <p>
          ...
          sending an e-mail to Bits And Bytes IT Solutions. Please include your
        ...
        <p>
          No use of Bits And Bytes IT Solutions's logo or other artwork will be
